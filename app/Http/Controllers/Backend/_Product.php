...
class Product extends Controller
{
    ...
    {
        $products = ModelsProduct::with('product_images', 'product_category', 'product_sub_category')->get();
        // dd($products);
    ...
    public function store(Request $request)
    {
        ...
        $created = ModelsProduct::create($data);
    ...
    public function edit($id)
    {
        ...
        $product = ModelsProduct::where('id', $id)->with('product_category', 'product_sub_category', 'product_images')->first();
        // $product = ModelsProduct::where('id', $id)->with('product_images')->first();
    ...
    public function update(Request $request, $id)
    {
        ...
        ModelsProduct::where('id', $id)->update($data);
        ...
        //         $file_name = time().rand(100,999).$orignalImageName;
        //         $image->move(public_path('upload/product/'.date('Y-m').'/'), $file_name);
        //         $product_img_data['img_url'] = 'upload/product/'.date('Y-m').'/'.$file_name;
        //         ProductImage::create($product_img_data);
        //     }
    ...
    public function orderDetails($id) {
        ...
        foreach($productIDs as $key => $pro) {
            // dd($pro);
            $p = ModelsProduct::where('id', $pro)->first();
            $p->qty= $quantity[$key];
            $products[] =$p;
        }
