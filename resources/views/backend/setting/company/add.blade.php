                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="phone_no"
                                value="{{ old('phone', $company->phone  ?? '') }}" id="company_phone">
                            @error('phone')
                            <span class="alert alert-danger p-3 custom-alert-d"> {{ $message }} </span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            <label>
                              <input type="checkbox" name="show_in_home_grid" class="flat-red">
                              &nbsp; Show in Home Grid
                            </label>
                        </div>
                        <div class="form-group">
                            <label>
                              <input type="checkbox" name="show_in_home_tab" class="flat-red">
                              &nbsp; Show in Home Tab
                            </label>
                        </div>
                        ...
                        {{-- <div class="form-check">
                            ...
                            @forelse ($product_categories as $cat)
                                <input class="form-check-input" type="checkbox" name="categories[]" value="{{ $cat->id }}" id="flexCheckDefault">
