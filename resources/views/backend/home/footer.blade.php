          ...
          <div class="col-md-12">
            ...
            <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">Footer<small></small></h3>
              </div>
              <!-- /.card-header -->
                        ...
                        @for ($i=1; $i<=6; $i++)
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="menu_{{$i}}" value="{{ old('menu_'.$i, isset($footer->{'menu_'.$i}) ? $footer->{'menu_'.$i} : '') }}" id="menu">
