                ...
                <form action="{{ route('admin.contact-us.update',$contact_us->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="heading" value="{{ old('heading', $contact_us->heading ?? '') }}"  class="form-control" id="termOfUseHeading" placeholder="Enter Heading" required>
                        </div>

                        <div class="form-group">
                            <label>Description</label>
                            <textarea class="form-control" rows="6" name="description" placeholder="Enter Description" required>
                                {{ old('description', $contact_us->description ?? '') }}
                            </textarea>
                        </div>
