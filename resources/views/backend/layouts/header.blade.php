    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        {{-- <ul class="navbar-nav">
          ...
          <li class="nav-item d-none d-sm-inline-block">
            <a href="{{ url('/listing') }}" class="nav-link" target="_blank">Our Products</a>
          </li>
          <li class="nav-item d-none d-sm-inline-block">
            <a href="{{ url('/aboutus') }}" class="nav-link" target="_blank">About Us</a>
          </li>
          <li class="nav-item d-none d-sm-inline-block">
            <a href="{{ url('/contactus') }}" class="nav-link" target="_blank">Contact Us</a>
          </li>
          <li class="nav-item d-none d-sm-inline-block">
            <a href="{{ url('/privacy-policy') }}" class="nav-link" target="_blank">Privacy Policy</a>
          </li>
        </ul> --}}
